...
proyecto, fuera de git — ver `.gitignore`) en vez de una base de datos: es
una lista chica que edita un solo usuario desde su compu/celu, no hace
falta más que eso.
"""
import json
...
RUTA_FAVORITOS = Path(__file__).resolve().parent.parent / "favoritos.json"
